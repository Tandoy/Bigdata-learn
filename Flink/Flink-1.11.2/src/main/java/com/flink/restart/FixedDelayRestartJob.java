...
//                RestartStrategies.fixedDelayRestart(3, Time.of(3, TimeUnit.SECONDS) ));
        ...
        SingleOutputStreamOperator<Tuple3<String, Integer, String>> map = source.map(new MapFunction<Tuple3<String, Integer, Long>, Tuple3<String, Integer, String>>() {
            @Override
