...
public class KafkaProducerUtil {
    ...
    public static void writeToKafka(String topic) throws Exception{
        ...
        // 用缓冲方式读取文本
        BufferedReader bufferedReader = new BufferedReader(new FileReader("D:\\Downloads\\github\\Bigdata-learn\\Flink\\Flink-1.11.2\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv"));
        String line;
