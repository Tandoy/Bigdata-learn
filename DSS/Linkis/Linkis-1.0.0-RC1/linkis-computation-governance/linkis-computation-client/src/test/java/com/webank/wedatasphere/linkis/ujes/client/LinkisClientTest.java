...
/**
 * java test Linkis-1.0-rc1 without Label
 */
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            JobExecuteResult jobExecuteResult = client.execute(JobExecuteAction.builder()
                    ...
                    .setEngineType((JobExecuteAction.EngineType) JobExecuteAction.EngineType$.MODULE$.SPARK()) // 希望请求的linkis的执行引擎类型，如Spark hive等
